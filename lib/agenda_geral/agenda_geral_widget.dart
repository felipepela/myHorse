...
import 'agenda_geral_model.dart';
export 'agenda_geral_model.dart';

class AgendaGeralWidget extends StatefulWidget {
  const AgendaGeralWidget({super.key});

  static String routeName = 'AgendaGeral';
  static String routePath = '/agendaGeral';

  @override
  State<AgendaGeralWidget> createState() => _AgendaGeralWidgetState();
}

class _AgendaGeralWidgetState extends State<AgendaGeralWidget> {
  late AgendaGeralModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AgendaGeralModel());

    logFirebaseEvent('screen_view', parameters: {'screen_name': 'AgendaGeral'});
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<HorsesRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<HorsesRecord> agendaGeralHorsesRecordList = snapshot.data!;
          ...
          child: Scaffold(
            ...
            appBar: AppBar(
              ...
              leading: FlutterFlowIconButton(
                ...
                onPressed: () async {
                  logFirebaseEvent('AGENDA_GERAL_arrow_back_rounded_ICN_ON_T');
                                              ...
                                              child: Row(
                                                ...
                                                children: [
                                                  ...
                                                  InkWell(
                                                    ...
                                                    onTap: () async {
                                                      logFirebaseEvent(
                                                          'AGENDA_GERAL_Container_fqeb1v80_ON_TAP');
                                                      logFirebaseEvent(
                                            ...
                                            child: Row(
                                              ...
                                              children: [
                                                ...
                                                InkWell(
                                                  ...
                                                  onTap: () async {
                                                    logFirebaseEvent(
                                                        'AGENDA_GERAL_Container_ltz8swm3_ON_TAP');
                                                    logFirebaseEvent(
                                                        'Container_bottom_sheet');
                                                    await showModalBottomSheet(
