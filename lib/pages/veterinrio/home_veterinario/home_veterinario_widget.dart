...
class _HomeVeterinarioWidgetState extends State<HomeVeterinarioWidget> {
  late HomeVeterinarioModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => HomeVeterinarioModel());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'HomeVeterinario'});
                    ...
                    Column(
                      ...
                      children: [
                        FlutterFlowIconButton(
                          ...
                          onPressed: () async {
                            logFirebaseEvent(
                                'HOME_VETERINARIO_PAGE_logout_ICN_ON_TAP');
                      ...
                      itemBuilder: (context, listViewIndex) {
                        ...
                        return Padding(
                          ...
                          child: InkWell(
                            ...
                            onTap: () async {
                              logFirebaseEvent(
                                  'HOME_VETERINARIO_Container_dxmu67qc_ON_T');
                              ...
                              children: [
                                StreamBuilder<UsersRecord>(
                                  stream: UsersRecord.getDocument(
                                      listViewCavalosConsultasRecord.dono!),
                                  builder: (context, snapshot) {
                                    // Customize what your widget looks like when it's loading.
                                    if (!snapshot.hasData) {
                                      return Center(
                                ...
                                Padding(
                                  ...
                                  child: StreamBuilder<HorsesRecord>(
                                    stream: HorsesRecord.getDocument(
                                        listViewCavalosConsultasRecord.cavalo!),
                                    builder: (context, snapshot) {
                                      // Customize what your widget looks like when it's loading.
                                      if (!snapshot.hasData) {
                                        return Center(
                                ...
                                FFButtonWidget(
                                  onPressed: () async {
                                    logFirebaseEvent(
                                        'HOME_VETERINARIO_PAGE_VER_BTN_ON_TAP');
