...
class CavaloAtividadesWidget extends StatefulWidget {
  const CavaloAtividadesWidget({
    super.key,
...
class _CavaloAtividadesWidgetState extends State<CavaloAtividadesWidget> {
  late CavaloAtividadesModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CavaloAtividadesModel());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'CavaloAtividades'});
    ...
    return GestureDetector(
      ...
      child: Scaffold(
        ...
        floatingActionButton: FloatingActionButton(
          onPressed: () async {
            logFirebaseEvent('CAVALO_ATIVIDADES_FloatingActionButton_e');
        ...
        appBar: AppBar(
          ...
          leading: FlutterFlowIconButton(
            ...
            onPressed: () async {
              logFirebaseEvent('CAVALO_ATIVIDADES_arrow_back_rounded_ICN');
                                      ...
                                      child: Row(
                                        ...
                                        children: [
                                          ...
                                          FlutterFlowIconButton(
                                            ...
                                            onPressed: () async {
                                              logFirebaseEvent(
                                                  'CAVALO_ATIVIDADES_highlight_off_ICN_ON_T');
                                              logFirebaseEvent(
