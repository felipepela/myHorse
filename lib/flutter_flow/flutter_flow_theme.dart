...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF041E3A);
  late Color secondary = const Color(0xFFBAAD72);
  late Color tertiary = const Color(0xFFBAAD72);
  late Color alternate = const Color(0xFFF1F4F8);
  late Color primaryText = const Color(0xFF000000);
  late Color secondaryText = const Color(0xFF57636C);
  late Color primaryBackground = const Color(0xFFFFFFFF);
  late Color secondaryBackground = const Color(0xFFFFFFFF);
  late Color accent1 = const Color(0xFF041E3A);
  late Color accent2 = const Color(0xFFBAAD72);
  late Color accent3 = const Color(0xFFBAAD72);
