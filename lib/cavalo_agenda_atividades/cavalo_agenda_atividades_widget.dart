...
import 'cavalo_agenda_atividades_model.dart';
export 'cavalo_agenda_atividades_model.dart';

class CavaloAgendaAtividadesWidget extends StatefulWidget {
  const CavaloAgendaAtividadesWidget({
    super.key,
  ...
  static String routeName = 'CavaloAgendaAtividades';
  static String routePath = '/cavaloAgendaAtividades';

  @override
  State<CavaloAgendaAtividadesWidget> createState() =>
      _CavaloAgendaAtividadesWidgetState();
}

class _CavaloAgendaAtividadesWidgetState
    extends State<CavaloAgendaAtividadesWidget> {
  late CavaloAgendaAtividadesModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CavaloAgendaAtividadesModel());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'CavaloAgendaAtividades'});
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          leading: FlutterFlowIconButton(
            ...
            onPressed: () async {
              logFirebaseEvent('CAVALO_AGENDA_ATIVIDADES_arrow_back_roun');
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        ...
                                        InkWell(
                                          ...
                                          onTap: () async {
                                            logFirebaseEvent(
                                                'CAVALO_AGENDA_ATIVIDADES_Container_xovlp');
                                            logFirebaseEvent(
